const Discord = requore("discord.js")
const ms = require('ms')
...
module.exports = {
    ...
    options: [
        ...
        {
            name: 'opção1',
            description: 'Adicione a opção 1',
            type: Discord.ApplicationCommandOptionType.String,
            required: true,
        },
        {
            name: 'opção2',
            description: 'Adicione a opção 2',
            type: Discord.ApplicationCommandOptionType.String,
            required: true,
        }, 
        {
            name: 'opção3',
            description: 'Adicione a opção 3',
            type: Discord.ApplicationCommandOptionType.String,
            required: true,
        }
    ],
        run: async (client, interaction) => {
            if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
                ...
                const op3 = interaction.options.getString('opção3')
